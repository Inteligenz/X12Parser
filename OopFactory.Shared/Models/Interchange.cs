namespace OopFactory.X12.Shared.Models
{
    ...
    public class Interchange : Container, IXmlSerializable
    {
        ...
        {
            FunctionGroup fg = new FunctionGroup(_specFinder, this, this.DelimiterSet, segmentString);
        ...
        public FunctionGroup AddFunctionGroup(string functionIdCode, DateTime date, int controlNumber, string version)
        {
            ...
            FunctionGroup fg = new FunctionGroup(_specFinder, this, this.DelimiterSet,
        ...
        internal override void WriteXml(XmlWriter writer)
        {
            if (!string.IsNullOrEmpty(SegmentId))
            {
                ...
                {
                    case '\x1D':
                        string terminator = Convert.ToBase64String(ASCIIEncoding.ASCII.GetBytes(this.DelimiterSet.SegmentTerminator.ToString()));
