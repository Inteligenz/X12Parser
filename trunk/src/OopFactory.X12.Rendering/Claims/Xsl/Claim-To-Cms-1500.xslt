...
>
  ...
  <xsl:template name="claim-header">
    ...
    <xsl:choose>
      <xsl:when test="count($claim/RelatedCauses/Cause[@Code='EM'])>0">
    ...
    <xsl:choose>
      <xsl:when test="count($claim/RelatedCauses/Cause[@Code='AA'])>0">
    ...
    <oop:box id="10-auto-accident-state" x="48" y="21" width="2.5" text-align="center">
      <xsl:value-of select="$claim/RelatedCauses/@State"/>
    </oop:box>
    ...
    <oop:box id="12-patient-signature" x="9" y="28.5" width="25" text-align="center">
      <xsl:choose>
        <xsl:when test="$claim/PatientSignatureSource/@Code='B'">SIGNATURE ON FILE</xsl:when>
        <xsl:when test="$claim/PatientSignatureSource/@Code='C'">SIGNATURE ON FILE</xsl:when>
        <xsl:when test="$claim/PatientSignatureSource/@Code='P'">SIGNATURE GENERATED BY PROVIDER</xsl:when>
        <xsl:when test="$claim/PatientSignatureSource/@Code='S'">SIGNATURE ON FILE</xsl:when>
      </xsl:choose>
    </oop:box>
