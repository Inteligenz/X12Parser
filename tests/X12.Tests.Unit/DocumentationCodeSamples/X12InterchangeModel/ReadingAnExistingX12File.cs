...
";
        ...
        public void Create270Test()
        {
            ...
            */
            ...
            HL1SourceLoop.NM104_NameFirst = string.Empty;
            HL1SourceLoop.NM105_NameMiddle = string.Empty;
            HL1SourceLoop.NM106_NamePrefix = string.Empty;
            HL1SourceLoop.NM107_NameSuffix = string.Empty;
            ...
            HL2Info.NM104_NameFirst = string.Empty;
            HL2Info.NM105_NameMiddle = string.Empty;
            HL2Info.NM106_NamePrefix = string.Empty;
        ...
        public void Transform270ToHtml()
        {
            ...
            Stream ediFile = new MemoryStream(Encoding.ASCII.GetBytes(this.inquiry));
