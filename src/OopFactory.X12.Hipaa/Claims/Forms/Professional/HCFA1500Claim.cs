...
namespace OopFactory.X12.Hipaa.Claims.Forms.Professional
{
    public class HCFA1500Claim
    {
        ...
        private List<HCFA1500Diagnosis> _Field21_Diagnoses = new List<HCFA1500Diagnosis>();
        public List<HCFA1500Diagnosis> Field21_Diagnoses { get { return _Field21_Diagnoses; } }                         // 3-1-4 part diagnosis code.
        ...
        private List<HCFA1500ServiceLine> _Field24_ServiceLines = new List<HCFA1500ServiceLine>();
