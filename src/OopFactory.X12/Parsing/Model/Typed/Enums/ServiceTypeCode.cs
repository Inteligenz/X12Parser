...
namespace OopFactory.X12.Parsing.Model.Typed.Enums
{
    public enum ServiceTypeCode
    {
        ...
        [EDIFieldValue("BW")]
        MailOrderPrescriptionDrug_BrandName,
        [EDIFieldValue("BX")]
        MailOrderPrescriptionDrug_Generic,
        [EDIFieldValue("BY")]
        PhysicianVisitSick,
        [EDIFieldValue("BZ")]
        PhysicianVisitWell,
        ...
        Screeninglaboratory,
        [EDIFieldValue("CM")]
        Mammogram_HighRiskPatient,
        [EDIFieldValue("CN")]
        Mammogram_LowRiskPatient,
        [EDIFieldValue("CO")]
        FluVaccination,
        [EDIFieldValue("CP")]
        EyewearAccessories,
        ...
        Oncology,
        [EDIFieldValue("PE")]
        PositronEmissionTomography_PET_Scan,
        [EDIFieldValue("PT")]
        PhysicalTherapy,
        [EDIFieldValue("PU")]
        Pulmonary,
