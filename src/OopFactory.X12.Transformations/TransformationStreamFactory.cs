    ...
    public static class TransformationStreamFactory
    {
        ...
        public static Stream GetHtmlTransformationStream()
        {
            return Assembly
                    ...
                    .GetManifestResourceStream("OopFactory.X12.Transformations.Resources.X12-XML-to-HTML.xslt");
        }
        ...
        public static Stream GetX12TransformationStream()
        {
            return Assembly
                    .GetExecutingAssembly()
                    .GetManifestResourceStream("OopFactory.X12.Transformations.Resources.X12-XML-to-X12.xslt");
        }
    }
}
